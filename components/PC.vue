<template>
    <section class="fixed top-0 left-0 px-4 bg-dark bg-opacity-70 flex items-center justify-center z-50 w-full h-full backdrop-blur-md" @click.self="$emit('pc-toggle')">
