<template>
    <nav class="fixed top-0 left-0 w-full z-40 mt-2 px-4">
        <div
            class="max-w-4xl m-auto flex items-center rounded-md p-2 px-3 justify-between bg-black bg-opacity-30 backdrop-blur-lg border border-white/10">
            ...
            <ul class="flex items-center text-white/90 link mr-3 690px:hidden">
                ...
                <div class="relative">
                    <span class="ml-7 cursor-pointer flex items-center" @click="server = !server">Servers
                        <Icon name="tabler:caret-down-filled" class="ml-1" />
                    </span>
                    <ul class="absolute w-[200px] text-start right-0 top-9 rounded-lg text-white flex flex-col bg-dark p-6 link"
                        v-if="server">
                        <span class="pb-0 cursor-pointer border-none border-dark-100" @click="pc = !pc">PC Server</span>
            ...
            <div class="690px:block hidden relative">
                ...
                <ul class="absolute w-[200px] text-start right-0 top-9 rounded-lg text-white flex flex-col bg-dark p-6 link"
                    ...
                    <NuxtLink class="py-3 border-b border-dark-100" to="https://awj.tip4serv.com/" target="_blank">Store
                    </NuxtLink>
