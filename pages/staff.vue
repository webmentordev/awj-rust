<template>
    <section class="w-full bg-center bg-cover min-h-screen relative" style="background-image: url('/staff_background.webp');">
        ...
        <div class="relative z-10 max-w-2xl m-auto pt-[140px] px-4">
            ...
            <div class="grid gap-2 grid-cols-2 justify-center mt-5 mb-5 550px:grid-cols-1 550px:max-w-[300px] 550px:m-auto">
                ...
                <div class=" text-white w-full">
                    <div class="bg-black p-6 rounded-lg relative group">
                        <img class="mb-5 rounded-md group-hover:scale-125 transition-all w-full" src="/awj_owner.png">
                        <div class="info">
                            <h2 class="text-center text-xl mb-2">AWJ IZYOUMADD</h2>
                            <span class="rounded-sm font-semibold p-2 text-sm px-3 bg-rust inline-block mb-3 w-full text-center">Owner (Console Servers)</span>
                            <div class="flex text-md items-center justify-center">
                                <Icon class="mr-2" name="logos:discord-icon" />
                                <span class="text-sm">awjizyoumaddd</span>
                            </div>
                        </div>
                    </div>
                </div>
