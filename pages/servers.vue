        ...
        <div class="relative z-10 max-w-6xl m-auto py-[140px] px-4">
            ...
            <div class="grid grid-cols-1 gap-3 800px:grid-cols-1" v-if="server_pvp">
                ...
                <div class="flex flex-col p-3 max-w-lg m-auto rounded-lg mt-6 bg-dark relative">
                    ...
                    <img src="https://api.rustyuranium.online/api/files/1pmot3sjdt94wfe/8tkcx8sgn9efo1f/awj_banner_2_cgGtny5Vmg.png"
                        class="rounded-lg" alt="Rusty Uranium Header Image">
                    <div class="p-3">
...
await $fetch("https://api.battlemetrics.com/servers/28991069").then(result => {
