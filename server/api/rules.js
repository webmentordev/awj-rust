export default defineEventHandler(() => {
    return {
        ...
        "all": [
            "Max Players In Team 6",
            "No Hacking/Aim Assist Clients/Devices",
            "No Racist / Homophobic / Abusive / Sexual Messages In Server Or Chat",
            "Links and images may not contain pornography/ racism /controversial imagery reference or not.",
            "Respect Any Players No Matter Their Role",
            "Please Use Ticket System For Help",
            "Do Not Promote Any Server/Service, What Is Not Associate With AWJ Rust",
            "Be Patient And Respect The Owner And Staff."
        ]
    }
})